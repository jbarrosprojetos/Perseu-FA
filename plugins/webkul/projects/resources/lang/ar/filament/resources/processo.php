...
return [
    ...
    'form' => [
        'sections' => [
            ...
            'settings' => [
                ...
                'fields' => [
                    'visibility'                   => 'الرؤية',
                    'visibility-hint-tooltip'      => 'اسمح للموظفين بالوصول إلى عمليتك أو مهامك عن طريق إضافتهم كمتابعين. سيحصلون تلقائياً على حق الوصول لأي مهام مسندة إليهم.',
    ...
    'table' => [
        ...
        'actions' => [
            ...
            'restore' => [
                'notification' => [
                    'title' => 'تم استعادة العملية',
                    'body'  => 'تم استعادة العملية بنجاح.',
                ],
            ],
            ...
            'force-delete' => [
                ...
                'notification' => [
                    ...
                    'success' => [
                        'title' => 'تم حذف العملية نهائياً',
                        'body'  => 'تم حذف العملية نهائياً بنجاح.',
                    ],

                    'error' => [
                        'title' => 'لا يمكن حذف العملية نهائياً',
                        'body'  => 'العملية مرتبط بسجلات أخرى.',
                    ],
        ...
        'sections' => [
            ...
            'additional' => [
                ...
                'entries' => [
                    'processo-manager'        => 'مدير العملية',
                    'customer'               => 'العميل',
                    'processo-timeline'       => 'الجدول الزمني للمشروع',
                    'allocated-hours'        => 'الساعات المخصصة',
